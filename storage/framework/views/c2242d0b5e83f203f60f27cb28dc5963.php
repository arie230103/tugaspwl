                    ...
                    <div class="product-item bg-light mb-4">
                        <div class="product-img position-relative overflow-hidden">
                            ...
                            <div class="product-action">
                                ...
                                <?php endif; ?>
                                <a class="btn btn-outline-dark btn-square" href="<?php echo e(route('store.product.show', $data->id)); ?>"><i class="fa fa-search"></i></a>
                            </div>
                        </div>
...
<?php echo $__env->make('store.layouts.store', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/manusiacoding/Documents/faw-development/project/arie-shop/resources/views/store/pages/index.blade.php ENDPATH**/ ?>