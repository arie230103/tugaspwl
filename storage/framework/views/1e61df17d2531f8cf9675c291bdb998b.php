                ...
                <tbody class="align-middle">
                    ...
                    <tr id="cart-row">
                        <td class="align-middle" align="center">
                            ...
                            <input type="hidden" id="product_id" value="<?php echo e($data->product_id); ?>" />
                        </td>
                        ...
                        <td class="align-middle">
                            ...
                            <input type="hidden" value="<?php echo e($priceAfterDiscount); ?>" id="price">
                            <?php else: ?>
                            <?php echo e('Rp ' . number_format($data->price, 0, ',', '.')); ?>

                            <input type="hidden" value="<?php echo e($data->price); ?>" id="price">
                            <?php endif; ?>

                            <input type="hidden" value="<?php echo e($data->is_discount == 1 ? $priceAfterDiscount : $data->price); ?>" class="price" />
                        </td>
                        <td class="align-middle">
                        ...
                        <td class="align-middle">
                            <form action="<?php echo e(route('store.cart.destroy', $data->cart_id)); ?>" method="post">
                                <?php echo csrf_field(); ?>
...
<script>
    $(document).ready(() => {
        ...
        $('#transaction-button').on('click', function() {
            $.ajax({
                url: "<?php echo e(route('store.transaction.store')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('store.layouts.store', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\arie-shop\resources\views/store/pages/carts/index.blade.php ENDPATH**/ ?>